...
public class Piece
{
    ...
    public void Promote() { this.alive = true; }
    ...
    public double getScore()
    {
        ...
        if(this.alive) {
            ...
            if (this.color == 'W') {
                ...
                if (this.posY == 7) { value += 0.2; }
                //Position - last line -> change to Figure
                if (this.posY == 8) { value += 7.0; }
            ...
            if (this.color == 'B') {
                ...
                //Position - close to last line (2 lines)
                if (this.posY == 3) { value += 0.01; }
                //Position - close to last line (1 line)
                if (this.posY == 2) { value += 0.2; }
                //Position - last line -> change to Figure
                if (this.posY == 1) { value += 7.0; }
                //+-Position - empty line ahead (witout opposite pawn)
                //+-Defence - cover by other pawn
            }
